...
- Download the folder with the script version you need (3.0 or 3.3) to your HANA Large Instance unit as documented in [SAP HANA Large Instances high availability and disaster recovery on Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/hana-overview-high-availability-disaster-recovery).
